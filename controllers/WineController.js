...
$(document).ready(function () {
    "use strict";
    var obj, index, div = "", url = "../../app/Http/Controllers/WineController.php?cmd=1";
...
$(function () {
    ...
    $("#searchField").keyup(function () {
        ...
        var obj, div = "", index, url = "../../app/Http/Controllers/WineController.php?cmd=2&searchWord=" + $("#searchField").val();
...
$(document).ready(function () {
    'use strict';
    var obj, url = "../../app/Http/Controllers/WineController.php?cmd=3", index = "", li = "";
    obj = sendRequest(url);
    if (obj.result === 1) {
...
$(function () {
    ...
    $("#wineTypes li > a").click(function () {
        ...
        var obj, index, div = "", url = "../../app/Http/Controllers/WineController.php?cmd=4&wineType=" + this.innerHTML;
...
$(function () {
    ...
    $("#sortWines li > a").click(function () {
        ...
        var obj, index, div = "", url = "../../app/Http/Controllers/WineController.php?cmd=" + this.id;
